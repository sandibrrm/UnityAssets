...
#[derive(Debug)]
pub struct UnityAssetsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UnityAssetsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UnityAssets processing");
    
    let mut processor = UnityAssetsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UnityAssetsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UnityAssetsProcessor::new(false);
